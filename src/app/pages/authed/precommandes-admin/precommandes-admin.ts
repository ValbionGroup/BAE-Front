...
export class PrecommandesAdmin {
  ...
  protected readonly orders = signal<readonly Order[]>([
    {
      id: '#PC-0142', client: 'C. Renard', fullClient: 'Camille Renard', adh: 'ADH-2025-0142',
      items: 3, prix: 14.5, paye: 'Lydia', payeDetail: 'Lydia · 19:02',
      slot: '19:30', slotDetail: '19:30 — 19:45', status: 'pret', q: 'A12',
      picking: [
    ...
    {
      id: '#PC-0141', client: 'A. Picard', fullClient: 'Antoine Picard', adh: 'ADH-2025-0118',
      items: 2, prix: 7.0, paye: 'Lydia', payeDetail: 'Lydia · 19:05',
      slot: '19:30', slotDetail: '19:30 — 19:45', status: 'pret', q: 'A11',
      picking: [
    ...
    {
      id: '#PC-0140', client: 'M. Bensaid', fullClient: 'Marwane Bensaid', adh: 'ADH-2025-0203',
      items: 5, prix: 19.5, paye: 'Lydia', payeDetail: 'Lydia · 19:14',
      slot: '19:45', slotDetail: '19:45 — 20:00', status: 'encours', q: 'A09',
    ...
    {
      id: '#PC-0139', client: 'E. Vasseur', fullClient: 'Élise Vasseur', adh: 'ADH-2025-0089',
      items: 1, prix: 3.5, paye: 'CB', payeDetail: 'CB · 19:20',
      slot: '19:45', slotDetail: '19:45 — 20:00', status: 'encours', q: 'A08',
      picking: [
        { n: 'Hot-dog fromage', q: 1, p: 3.5, done: false },
      ],
    },
    {
      id: '#PC-0138', client: 'I. Dubreuil', fullClient: 'Inès Dubreuil', adh: 'ADH-2025-0156',
      items: 4, prix: 13.0, paye: 'Lydia', payeDetail: 'Lydia · 18:48',
      slot: '20:00', slotDetail: '20:00 — 20:15', status: 'attente', q: 'A07',
      picking: [
    ...
    {
      id: '#PC-0137', client: 'T. Bessière', fullClient: 'Tom Bessière', adh: 'ADH-2025-0044',
      items: 2, prix: 6.0, paye: 'CB', payeDetail: 'CB · 18:50',
      slot: '20:00', slotDetail: '20:00 — 20:15', status: 'attente', q: 'A06',
      picking: [
    ...
    {
      id: '#PC-0136', client: 'P. Aubry', fullClient: 'Pierre Aubry', adh: 'EXT-2025-0011',
      items: 3, prix: 11.5, paye: 'Lydia', payeDetail: 'Lydia · 19:01',
      slot: '20:00', slotDetail: '20:00 — 20:15', status: 'attente', q: 'A05',
      picking: [
        { n: 'Hot-dog fromage', q: 1, p: 3.5, done: false },
    ...
    {
      id: '#PC-0135', client: 'S. Lemaire', fullClient: 'Sofia Lemaire', adh: 'ADH-2024-0871',
      items: 2, prix: 8.0, paye: 'CB', payeDetail: 'CB · 19:24',
      slot: '20:15', slotDetail: '20:15 — 20:30', status: 'attente', q: 'A04',
      picking: [
