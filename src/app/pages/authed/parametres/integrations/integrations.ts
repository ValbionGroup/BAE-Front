  ...
  protected readonly integrations: readonly Integration[] = [
    {
      ...
      cat: 'Paiements',
      s: 'on',
      acc: 'BAE-ESC · pro@bae-esc.fr',
      last: 'sync il y a 2 min',
      logo: 'L',
      cls: 'text-blue bg-blue-soft',
    },
    {
      n: 'Carrefour Pro',
      cat: 'Courses',
      s: 'on',
      acc: 'Carte #21-4218',
      last: "3 bons d'achat actifs",
      logo: 'C',
      cls: 'text-red bg-red-soft',
    },
    {
      n: 'Métro France',
      cat: 'Courses',
    ...
    },
    {
      ...
      s: 'on',
      acc: 'bae-esc.fr',
      last: 'SSO actif · 14 comptes',
      logo: 'G',
      cls: 'text-ok bg-ok-soft',
    },
    {
      n: 'HelloAsso',
      cat: 'Cotisations',
